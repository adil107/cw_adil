...
const StackedSideNav = () => {
    ...
    return (
        <>
            {larger.md && (
                <div className={`stacked-side-nav`} style={{ zIndex: 40 }}>
                    <StackedSideNavMini
                    ...
                    />
                    <div
                        className={`stacked-side-nav-secondary absolute z-1 h-full} ${navColor(
                            'stacked-side-nav-secondary',
                            mode,
                            false
                        )}`}
                        style={{
                            left: isEmpty(selectedMenu) ? '-250px' : '80px',
                            height: selectedMenu ? '100%' : '',
